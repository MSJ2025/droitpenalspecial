enum Category {
  ...
  administration('Infractions contre l\'Etat et l\'autorite publique'),
  paixPublique('Infractions contre la paix publique'),
  autres('Autres infractions');
...
const Map<Category, List<String>> categoryFamilies = {
  Category.personnes: [
    ...
    'Atteintes \u00e0 l\'exercice de l\'autorite parentale',
  ],
  Category.biens: [
  ...
  Category.administration: [
    ...
    'Infractions contre l\'autorite judiciaire et l\'ordre public',
    'Infractions aux r\u00e8gles de d\u00e9claration et d\u00e9utilisation des traitements informatis\u00e9s',
  ],
  Category.paixPublique: [
